...
<nav class="page-sidebar" data-pages="sidebar">
  ...
  <div class="sidebar-header">
    <img src="assets/img/logo_blue.png" alt="logo" class="brand" data-src="assets/img/logo_blue.png" data-src-retina="assets/img/logo_blue_2x.png" width="78" height="22">
  </div>
...
<div class="page-container">
  ...
  <div class="header ">
    ...
    <div class="">
      ...
      <a href="#" class="btn btn-link text-primary m-l-20 d-none d-lg-inline-block d-xl-inline-block">Add New Item</a>
    ...
    <div class="d-flex align-items-center">
      ...
      <ul class="d-lg-inline-block d-none notification-list no-margin b-grey b-r no-style p-l-30 p-r-20">
...
<!-- BEGIN PAGE LEVEL JS -->
<script src="assets/js/scripts_alt.js" type="text/javascript"></script>
<!-- END PAGE LEVEL JS -->
</body>
</html>