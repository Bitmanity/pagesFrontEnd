  ...
  <body class="fixed-header">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
      ...
      <div class="sidebar-header">
        <img src="assets/img/logo_blue.png" alt="logo" class="brand" data-src="assets/img/logo_blue.png" data-src-retina="assets/img/logo_blue.png" width="78" height="22">
          ...
          <div class="">
            ...
            <ul class="d-lg-inline-block d-none notification-list no-margin d-lg-inline-block b-grey b-l b-r no-style p-l-30 p-r-20">
              <li class="p-r-10 inline">
                <div class="dropdown">
                  <a class="header-icon pg pg-world" data-toggle="dropdown" href="javascript:;" id="notification-center"><span class="bubble"></span></a> <!-- START Notification Dropdown -->
                      ...
                      <div class="notification-body scrollable">
                        ...
                        <div class="notification-item unread clearfix">
                          ...
                          <div class="heading open">
                            <a class="text-complete pull-left" href="#"><i class="pg-map fs-16 m-r-10"></i> <span class="bold">Carrot Design</span> <span class="fs-12 m-l-10">David Nester</span></a>
                            <div class="pull-right">
                              <div class="thumbnail-wrapper d16 circular inline m-t-15 m-r-10 toggle-more-details">
                                <div>
                                  <i class="fa fa-angle-left"></i>
                                </div>
                              </div><span class=" time">few sec ago</span>
                            </div>
                            <div class="more-details">
                              <div class="more-details-inner">
                                ...
                                <p class="small hint-text">
                                  Commented on john Smiths wall.<br>
                                  via pages framework.
                                </p>
                              </div>
                            </div>
                          ...
                          <div class="option" data-placement="left" data-toggle="tooltip" title="mark as read">
                            <a class="mark" href="#"></a>
                          </div><!-- END Notification Item Right Side-->
                        ...
                        <div class="notification-item clearfix">
                          ...
                          </div><!-- START Notification Item Right Side-->
                          <div class="option">
                            <a class="mark" href="#"></a>
                          </div><!-- END Notification Item Right Side-->
                        </div><!-- END Notification Item-->
                        ...
                        <div class="notification-item clearfix">
                          <div class="heading">
                            <a class="text-warning-dark pull-left" href="#"><i class="fa fa-exclamation-triangle m-r-10"></i> <span class="bold">Warning Notification</span> <span class="fs-12 m-l-10">Buy Now</span></a> <span class="pull-right time">yesterday</span>
                          </div><!-- START Notification Item Right Side-->
                          <div class="option">
                            <a class="mark" href="#"></a>
                          </div><!-- END Notification Item Right Side-->
                        ...
                        <div class="notification-item unread clearfix">
                          <div class="heading">
                            <div class="thumbnail-wrapper d24 circular b-white m-r-5 b-a b-white m-t-10 m-r-10">
                              <img alt="" data-src="{{asset('assets/img/profiles/1.jpg')}}" data-src-retina="{{asset('assets/img/profiles/1x.jpg')}}" height="30" src="{{asset('assets/img/profiles/1.jpg')}}" width="30">
                            </div><a class="text-complete pull-left" href="#"><span class="bold">Revox Design Labs</span> <span class="fs-12 m-l-10">Owners</span></a> <span class="pull-right time">11:00pm</span>
                          </div><!-- START Notification Item Right Side-->
                          <div class="option" data-placement="left" data-toggle="tooltip" title="mark as read">
                            <a class="mark" href="#"></a>
                          </div><!-- END Notification Item Right Side-->
          ...
          <div class="d-flex align-items-center">
            ...
            <div class="dropdown pull-right d-lg-block d-none">
              ...
              <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                <a class="dropdown-item" href="#"><i class="pg-settings_small"></i> Settings</a> <a class="dropdown-item" href="#"><i class="pg-outdent"></i> Feedback</a> <a class="dropdown-item" href="#"><i class="pg-signals"></i> Help</a> <a class="clearfix bg-master-lighter dropdown-item" href="#"><span class="pull-left">Logout</span> <span class="pull-right"><i class="pg-power"></i></span></a>
              </div>
            </div><!-- END User Info-->
            <a class="header-icon pg pg-alt_menu btn-link m-l-10 sm-no-margin d-inline-block" data-toggle="quickview" data-toggle-element="#quickview" href="#"></a>
          </div>
      </div>
      <!-- END HEADER -->
                    ...
                    <li class="chat-user-list clearfix">
                      <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                        <span class="thumbnail-wrapper d32 circular bg-success">
                            <img width="34" height="34" data-src-retina="{{asset('assets/img/profiles/1x.jpg')}}" data-src="{{asset('assets/img/profiles/1.jpg')}}" alt="" src="{{asset('assets/img/profiles/1.jpg')}}" class="col-top">
                        </span>
                        <p class="p-l-10 ">
