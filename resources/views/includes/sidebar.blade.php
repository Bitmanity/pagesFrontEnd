<nav class="page-sidebar" data-pages="sidebar">
    ...
    <div class="sidebar-header">
      <img src="{{asset('assets/img/logo_blue.png')}}" alt="logo" class="brand" data-src="{{asset('assets/img/logo_blue.png')}}" data-src-retina="{{asset('assets/img/logo_blue_2x.png')}}" width="78" height="22">
